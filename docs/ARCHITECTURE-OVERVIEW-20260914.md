> **ACCEPTED AS A DATED REFERENCE, 2026-09-23.** This is a snapshot of what
> existed on 14 September, with each component's evidence *and its limit*
> recorded. It is not a proposal and nothing in it is authorised by being here.
>
> Read it as history: the fleet has changed since. Landed from PR #110 rather
> than merged — the branch had drifted nine days and would not rebase. Content
> unchanged below.
