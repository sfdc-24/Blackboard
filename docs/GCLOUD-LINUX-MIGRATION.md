> **OBSOLETE 2026-09-26**: it replicates the Azure VM, which was dropped on 2026-09-24; line 59 also carries a wrong BUS_URL. Kept as history, do not follow it. How we work now: [`EXPRESS.md`](EXPRESS.md).
