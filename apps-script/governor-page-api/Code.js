...
function SYSTEM_PROMPT_(who) {
  ...
  return [
    ...
    // A live answer on 2026-09-24 said a permission set is "added to a user's
    // profile". It is not: it is assigned to the user, alongside the profile.
    "- Profiles: every user has exactly one profile, and a second cannot be assigned. Extra access goes on top of it with permission sets and permission set groups, which are assigned to the user directly (the user's record, Permission Set Assignments), never added to a profile.",
