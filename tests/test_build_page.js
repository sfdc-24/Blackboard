...
section('T1 · it renders a whole, self-contained page');
{
  ...
  check('defence-in-depth CSP blocks scripts, objects and network loads',
    html.includes("default-src 'none'") && html.includes("object-src 'none'") && html.includes("form-action 'none'"));
