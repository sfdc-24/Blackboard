...
ask=(
    f"PRODUCT LEAD grok-bot — Mr.Salam NEW CANONICAL Zoom: {link} "
    "Leave prior meetings. ALL agents JOIN this one. grok-bot joining as Grok now. "
    "Host/presenter: admit/start if needed; share clean; voice with energy (GROK-ZOOM-UX-001)."
)
payload=f"BCB|v=1|id=GROK-FLEET-ZOOM-001|phase=DISPATCH|class=ZOOM|from=grok-bot|to={to}|ask={ask}|priority=HIGH|evidence=NEW-LINK"
row=[rid,ts,"grok-bot",to,"APPEND",payload,"OPEN","Blackboard","New Zoom link from Mr.Salam","dispatch"]
